...
SRC = src/parsing/env.c src/parsing/expands.c src/parsing/expands_utils.c src/parsing/utils.c  src/parsing/utils2.c src/parsing/lexing.c\
	...
	src/redir/redir_utils5.c src/redir/redir_utils6.c src/redir/expand_hd.c\
	src/main.c src/main_utils.c src/execute/execute.c src/execute/execute_utils.c src/execute/execute_utils2.c\
	src/pipe/pipe_utils.c src/pipe/pipe_utils2.c src/pipe/pipe_main.c src/parsing/pro_pars.c src/pipe/pipe_helper.c\
